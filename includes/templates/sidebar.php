 ...
 *
 * $core is provided by EMFM_Plugin::render_sidebar().
 *
...
// Fallback in case template is included without $core being set.
if (!isset($core)) {
...
<div id="emf-folder-sidebar">
    <div id="emf-sidebar-header">
        <h2><?php esc_html_e('Folders', 'easy-media-folder-manager'); ?></h2>
        <button id="emf-sidebar-toggle" aria-expanded="true" aria-controls="emf-sidebar-collapsible">&#9650;</button>
    </div>
    <div id="emf-sidebar-collapsible">
        <button id="emf-new-folder-btn" class="button"><?php esc_html_e('New Folder', 'easy-media-folder-manager'); ?></button>
        <div id="emf-new-folder-form" style="display:none;">
            <input type="text" id="emf-new-folder-name" placeholder="<?php esc_attr_e('Folder Name', 'easy-media-folder-manager'); ?>" aria-label="<?php esc_attr_e('Folder Name', 'easy-media-folder-manager'); ?>" />
        ...
        <select id="emf-folder-sort" aria-label="<?php esc_attr_e('Sort folders', 'easy-media-folder-manager'); ?>">
